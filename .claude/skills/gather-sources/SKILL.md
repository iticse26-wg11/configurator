...
- **How the course should use it** → `how_to_use`. Get this right; it's what the build reads. Examples: *"Binding. Summarise in the overview; every activity involving GenAI tools must refer to it; use as the 'provided policy' in LA03/LA11."* — *"Use this reading list as recommended reading; don't add others."* — *"Match the structure and tone of these existing slides."*
