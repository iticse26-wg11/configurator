...
## Facilitation tips
Drawn from the source activities' guidance (debrief questions, surprising results to reveal, common pitfalls).

## If you have less time than planned
Which blocks to cut first, per session, without losing an ILO entirely.

## How your documents were used
Per attachment: title → where it appears (overview policy section, activity steps, readings).

## Adapting further
Point to `revise-course`: examples of requests that work well.
